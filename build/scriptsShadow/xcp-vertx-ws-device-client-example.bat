...
set CLASSPATH=%APP_HOME%\lib\xcp-vertx-ws-device-client-example-0.54.7-SNAPSHOT-fat.jar

@rem Execute xcp-vertx-ws-device-client-example
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %XCP_VERTX_WS_DEVICE_CLIENT_EXAMPLE_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
